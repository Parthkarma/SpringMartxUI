...
import { FiArrowUp, FiSearch , FiRefreshCw ,FiArrowDown }  from "react-icons/fi";
    ...
    <div className="flex lg:flex-row flex-col-reverse lg:justify-between justify-center items-center gap-4">      
     ...
     >
            ...
            <Tooltip title =  "Sorted by price :asc">              
                    <Button variant = "contained" onClick={toggleSortOrder} color="primary" className="flext items-center gap-2 h-10" >
                       sortby
                       {sortOrder === "asc" ? (
                        <FiArrowUp size = {20} />
                       ) : (
